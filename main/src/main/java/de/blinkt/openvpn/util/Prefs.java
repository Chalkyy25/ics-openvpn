...
public final class Prefs {
    ...
    public static String getToken(Context c) {
        return p(c).getString("token", null);
    }

    public static int getUserId(Context c) {
        return p(c).getInt("user_id", 0);
    }
    ...
    public static int getServerId(Context c) {
        return p(c).getInt("server_id", 0);
    }

    public static String getServerName(Context c) {
        return p(c).getString("server_name", null);
    }
}
